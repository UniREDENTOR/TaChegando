...
public class BuscarOnibusDialogFragment extends DialogFragment {
    ...
    public static BuscarOnibusDialogFragment novaInstancia(List<Viagem> listaDeViagensFiltrada) {
        ...
        bundle.putSerializable("lista", (Serializable) listaDeViagensFiltrada);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
      List<Viagem> listaFiltrada = (List<Viagem>) getArguments().getSerializable("lista");
         final BuscarOnibusAdapter adapter = new BuscarOnibusAdapter((ArrayList<Viagem>) listaFiltrada, getContext());
